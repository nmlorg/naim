...
typedef struct {
	...
	fte_t	(*im_add_buddy)(struct firetalk_driver_connection_t *c, const char *const account, const char *const group, const char *const friendly);
	...
	fte_t	(*chat_join)(struct firetalk_driver_connection_t *c, const char *const group);
	fte_t	(*chat_part)(struct firetalk_driver_connection_t *c, const char *const group);
	fte_t	(*chat_invite)(struct firetalk_driver_connection_t *c, const char *const group, const char *const account, const char *const text);
	fte_t	(*chat_set_topic)(struct firetalk_driver_connection_t *c, const char *const group, const char *const text);
	fte_t	(*chat_op)(struct firetalk_driver_connection_t *c, const char *const group, const char *const account);
	fte_t	(*chat_deop)(struct firetalk_driver_connection_t *c, const char *const group, const char *const account);
	fte_t	(*chat_kick)(struct firetalk_driver_connection_t *c, const char *const group, const char *const account, const char *const text);
